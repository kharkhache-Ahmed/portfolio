...
const Vscode = () => {
    return (
        ...
        <div className='
            ...
            w-full 
            bg-gray-950/70'>
            <span className='bg-red-500/70 vsCodeCircle'></span>
            <span className='bg-yellow-500/70 vsCodeCircle'></span>
            <span className='bg-green-500/70 vsCodeCircle'></span>
            <span className='text-white text-sm'>My story</span>
        </div>
